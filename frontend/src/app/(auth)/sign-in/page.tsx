    ...
    >
      ...
      <div className="bg-white p-5 sm:p-6 rounded-[24px] shadow-xl shadow-blue-500/5 border border-slate-100">
        <form className="space-y-4" onSubmit={submitForm}>
          ...
          <button type="submit" disabled={loading} className="w-full py-2.5 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-xl shadow-md shadow-blue-500/20 transition-all flex justify-center items-center mt-5 disabled:opacity-70 group">
