  ...
  return (
    <div className="w-full flex justify-center items-center h-full">
      <motion.div 
        ...
        className="w-full max-w-[420px] bg-white p-6 sm:p-8 rounded-[32px] shadow-2xl shadow-blue-500/10 border border-slate-100 max-h-[90vh] overflow-y-auto custom-scrollbar"
      >
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">Sign in to MT Labs</h1>
        ...
        <AnimatePresence>
          {error && (
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="mb-4 p-3 bg-red-50 text-red-600 text-sm font-bold rounded-xl border border-red-100 text-center">
              {error}
            </motion.div>
          )}
        </AnimatePresence>
        ...
        <div className="flex flex-col gap-3 mb-6">
          <button 
            ...
            type="button" 
            className="w-full flex justify-center items-center px-4 py-2.5 border border-slate-300 rounded-xl shadow-sm bg-white text-sm font-bold text-slate-700 hover:bg-slate-50 hover:border-slate-400 disabled:opacity-50 transition-all cursor-pointer"
          >
          ...
          <div className="grid grid-cols-2 gap-3">
            <button 
              ...
              disabled={!isLoaded || loadingProvider !== null}
              type="button" 
              className="flex justify-center items-center px-4 py-2.5 border border-slate-300 rounded-xl shadow-sm bg-white text-sm font-bold text-slate-700 hover:bg-slate-50 transition-all"
            >
        ...
        <form className="space-y-4" onSubmit={submitForm}>
          ...
          <button type="submit" disabled={loading} className="w-full py-3 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-xl shadow-lg shadow-blue-500/20 transition-all flex justify-center items-center mt-6 disabled:opacity-70 group">
