...
import { Mail, Lock, User, ArrowRight, Facebook, Apple, Eye, EyeOff, Loader2 } from "lucide-react";
        ...
        {!pendingVerification ? (
          <>
            ...
            <form className="space-y-4" onSubmit={submitForm}>
              ...
              <button type="submit" disabled={loading} className="w-full py-3 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-xl shadow-lg shadow-blue-500/20 transition-all flex justify-center items-center mt-4 disabled:opacity-70">
