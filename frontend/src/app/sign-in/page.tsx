...
export default function SignInPage() {
  return (
    <div className="min-h-screen w-full flex bg-slate-50">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-white shadow-2xl items-center justify-center">
        {/* The premium background image for desktop without any gradients or cards */}
        <Image
          src="/login-bg.png"
          alt="Login Premium"
          fill
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 sm:p-12 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col gap-3 mb-8">
            <button type="button" className="w-full flex justify-center items-center px-4 py-3.5 border border-slate-300 rounded-xl shadow-sm bg-white text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:border-slate-400 transition-all">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button type="button" className="w-full flex justify-center items-center px-4 py-3 border border-slate-300 rounded-xl shadow-sm bg-white text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:border-slate-400 transition-all">
